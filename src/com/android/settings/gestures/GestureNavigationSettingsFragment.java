...
public class GestureNavigationSettingsFragment extends DashboardFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        gestureHintPref.setOnPreferenceChangeListener((preference, newValue) -> {
            if (HertzifyUtils.isPackageInstalled(getContext(), NEXUSLAUNCHER_PACKAGE_NAME)) {
                HertzifyUtils.toggleOverlay(getContext(), NOGESTUREHINT_OVERLAY, !(Boolean) newValue);
                HertzifyUtils.restartApp(NEXUSLAUNCHER_PACKAGE_NAME, getContext());
            }
