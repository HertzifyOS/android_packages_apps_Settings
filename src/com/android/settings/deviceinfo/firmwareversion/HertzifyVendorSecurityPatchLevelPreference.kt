...
class HertzifyVendorSecurityPatchLevelPreference :
    ...
    override val purpose: Int
        get() = R.string.vendor_security_key_purpose
    ...
    override fun getSummary(context: Context): CharSequence {
        ...
        if (patchLevel.isEmpty()) {
            patchLevel = SystemProperties.get(HERTZIFY_VENDOR_SECURITY_PATCH_PROPERTY)
        }
    ...
    companion object {
        ...
        const val HERTZIFY_VENDOR_SECURITY_PATCH_PROPERTY: String =
            "ro.hertzify.build.vendor_security_patch"
    }
}