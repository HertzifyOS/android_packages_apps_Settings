...
public class GpuCompositionAppsSelectionFragment extends SettingsPreferenceFragment {
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        final MenuItem turnOnAllApps =
                menu.add(Menu.NONE, MENU_TURN_ON_ALL_APPS, Menu.NONE,
                        R.string.use_gpu_for_screen_composition_turn_on_all);
        turnOnAllApps.setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);

        final MenuItem turnOffAllApps =
                menu.add(Menu.NONE, MENU_TURN_OFF_ALL_APPS, Menu.NONE,
                        R.string.use_gpu_for_screen_composition_turn_off_all);
